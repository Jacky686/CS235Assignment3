...
# TODO CHANGE PATH FOR TESTING
# TEST_DATA_PATH = os.path.join('C:', os.sep, 'Users', 'Jacky', 'Documents', 'COMPSCI235-GitHub', 'CS235Assignment3',
#                               'tests', 'data')

TEST_DATA_PATH_MEMORY = os.path.join('C:', os.sep, 'Users', 'Jacky', 'Documents', 'COMPSCI235-GitHub',
                                     'CS235Assignment3', 'tests', 'data', 'memory')
TEST_DATA_PATH_DATABASE = os.path.join('C:', os.sep, 'Users', 'Jacky', 'Documents', 'COMPSCI235-GitHub',
                                       'CS235Assignment3', 'tests', 'data', 'database')
